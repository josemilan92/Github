...
public class BloqueQuizCinco {
    ...
    private static final String PREFER_NAME="QuizCinco";
    ...
    public BloqueQuizCinco(Context context){
    ...
    public boolean checkQuiz(){
        if(!this.isUserLogged()){
            Intent i=new Intent(_context, QuizActivityCinco.class);
