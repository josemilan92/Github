...
import mx.utng.edu.laeraningpatrones.resultados.ResultActivityTres;
...
public class QuizActivityTres extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		countDownTimer=new QuizActivityTres.MyCountDownTimer(starTime, interval);
		...
		quesList=db.getAllQuestionsTres();
