 ...
 */
public class LeccionCincoJson extends AppCompatActivity {
    ...
    public void ObtenerDatos(){
        ...
        String url="http://josemilan.esy.es/jose/conexioncinco.php";

        RequestParams parametros= new RequestParams();
        parametros.put("Salir", 7);

        final ProgressDialog progressDialog= new ProgressDialog(LeccionCincoJson.this);
