 ...
 */
public class LeccionTresJson extends AppCompatActivity {
    ...
    public void ObtenerDatos(){
        ...
        String url="http://josemilan.esy.es/jose/conexiontres.php";

        RequestParams parametros= new RequestParams();
        parametros.put("Salir", 7);

        final ProgressDialog progressDialog= new ProgressDialog(LeccionTresJson.this);
