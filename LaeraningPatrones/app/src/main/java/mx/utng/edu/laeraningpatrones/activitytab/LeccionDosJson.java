 ...
 */
public class LeccionDosJson extends AppCompatActivity {
    ...
    public void ObtenerDatos(){
        ...
        String url="http://josemilan.esy.es/jose/conexiondos.php";
        RequestParams parametros= new RequestParams();
        parametros.put("Salir", 7);
        final ProgressDialog progressDialog= new ProgressDialog(LeccionDosJson.this);
